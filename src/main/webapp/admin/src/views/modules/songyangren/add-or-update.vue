...
export default {
                	        ...
                	        songyanghao: '',
	                        	        ...
	                        	        zhaopian: '',
                                                                  ...
                                                                  xingbieOptions: [],
                                                                                          rules: {
                  songyanghao: [
                            { required: true, message: '送养号不能为空', trigger: 'blur' },
                                    	                                                              ],
                  songyangming: [
                            { required: true, message: '送养名不能为空', trigger: 'blur' },
                                    	                                                              ],
                  mima: [
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `songyangren/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.songyangrenCrossAddOrUpdateFlag = false;
                  this.parent.search();
