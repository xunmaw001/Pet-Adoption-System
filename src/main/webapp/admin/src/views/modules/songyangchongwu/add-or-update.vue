  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="手机" prop="shouji">
              <el-input v-model="ruleForm.shouji" 
                placeholder="手机" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="送养状态" prop="songyangzhuangtai">
          <el-select v-model="ruleForm.songyangzhuangtai" placeholder="请选择送养状态">
            <el-option
                v-for="(item,index) in songyangzhuangtaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="送养状态" prop="songyangzhuangtai">
	      <el-input v-model="ruleForm.songyangzhuangtai"
                placeholder="送养状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shouji = true;
            continue;
	            	            ...
	            	            if(o=='songyangzhuangtai'){
            this.ruleForm.songyangzhuangtai = obj[o];
	    this.ro.songyangzhuangtai = true;
            continue;
          }
	            	            	                    }
                                                                                                                                                                                              }
          ...
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                                                                                                                ...
                                                                                                                this.songyangzhuangtaiOptions = "待领养,已送养".split(',')
                                                                },
                                                                                                // 多级联动参数
                                                                                                                          info(id) {
      this.$http({
        url: `songyangchongwu/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `songyangchongwu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.songyangchongwuCrossAddOrUpdateFlag = false;
                  this.parent.search();
