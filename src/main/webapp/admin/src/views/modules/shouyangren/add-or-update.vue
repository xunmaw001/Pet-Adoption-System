...
export default {
                	        ...
                	        shouyanghao: '',
	                        	        ...
	                        	        zhaopian: '',
                                                                  ...
                                                                  xingbieOptions: [],
                                                                                          rules: {
                  shouyanghao: [
                            { required: true, message: '收养号不能为空', trigger: 'blur' },
                                    	                                                              ],
                  shouyangming: [
                            { required: true, message: '收养名不能为空', trigger: 'blur' },
                                    	                                                              ],
                  mima: [
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `shouyangren/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shouyangrenCrossAddOrUpdateFlag = false;
                  this.parent.search();
